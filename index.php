    ...
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Master Data  © <?= date("Y") ?> - <?= $_SESSION['setting_name'] ?> | <a href="deni.pangeran25@gmail.com" target="_blank">deni.pangeran25@gmail.com</a> | Reposted by <a href="" target="_blank" rel="noopener noreferrer">Aplikasi Jual Beli Pizza</a></div></div>
        </footer>
